...
<textarea id="message" rows="4" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Write your thoughts here..."></textarea>
  </div>
  <div className="flex items-center justify-center py-5">
  <a className="text-red-900 border-red-900 border px-10 py-2 rounded-md font-bold hover:bg-red-900 hover:text-white hover:shadow-xl hover:shadow-red-900" href="#">Enviar</a>
  </div>
</form>
    </main>
}